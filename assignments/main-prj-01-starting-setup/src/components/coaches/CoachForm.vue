  ...
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control"
      ...
      <input type="number" id="rate" 
        ...
        />
      <p v-if="!rate.isValid">Rate must be entered and be a positive number!</p>
    </div>
    <div class="form-control"
      ...
      <div>
        <input type="checkbox" id="career" value="career" 
          ...
          @blur="clearInValid('areas')"
          />
        <label for="career">Career Adisory</label>
      </div>
      <p v-if="!areas.isValid">You must enter at least 1 area of expertise!</p>
    </div>
